...
function popupCal() {
    ...
    if (tmpString == "")
        ...
        var arr = popCalDstFmt.split("/");
        var arrVal = tmpString.split("/");
        var _year = "";
        if (arr[0].indexOf("y") >= 0) {
            _year = arrVal[0];
            if (_year.length == 2) {
                _year = "20" + _year;
                tmpString = _year + "/" + arrVal[1] + "/" + arrVal[2];
            }
        }
        else if (arr[1].indexOf("y") >= 0) {
            _year = arrVal[1];
            if (_year.length == 2) {
                _year = "20" + _year;
                tmpString = arrVal[0] + "/" + _year + "/" + arrVal[2];
            }
        }
        else {
            _year = arrVal[2];
            if (_year.length == 2) {
                _year = "20" + _year;
                tmpString = arrVal[0] + "/" + arrVal[1] + "/" + _year;
            }
        }
...
function calPopupSetDate() {
    ...
    $(calPopupSetDate.arguments[0]).change();
}
